...
$(function(){
	...
	$(".viewStyle").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/jsp/style.do?method=view&style="+ obj.attr("style");
	});
	...
	$(".modifyStyle").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/jsp/style.do?method=modify&style="+ obj.attr("style");
	});
	$('#no').click(function () {
		cancleBtn();
	});
